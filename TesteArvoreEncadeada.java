...
public class TesteArvoreEncadeada extends TestCase{
	
	ArvoreBinariaEncadeada<String> arvore;
	ArvoreBinariaEncadeada<Integer> arvoreNumerica;
	
	@Override
	protected void setUp() throws Exception {
        super.setUp();
        this.arvore= new ArvoreBinariaEncadeada<String>();
        this.arvoreNumerica= new ArvoreBinariaEncadeada<Integer>();
    }
	...
	public void testRetornaArvoreDireita(){
		...
		this.arvore.insere("burro");
		this.arvore.insere("zebra");
		ArvoreBinariaEncadeada<String> arvoreDireita = new ArvoreBinariaEncadeada<String>();
		arvoreDireita.insere("lontra");
		arvoreDireita.insere("zebra");
		ArvoreBinariaEncadeada<String> novaArvore = this.arvore.retornaArvoreDireita("jumento");
	...
	public void testRetornaArvoreEsquerda(){
		...
		this.arvore.insere("burro");
		this.arvore.insere("zebra");
		ArvoreBinariaEncadeada<String> arvoreEsquerda = new ArvoreBinariaEncadeada<String>();
		arvoreEsquerda.insere("foca");
		arvoreEsquerda.insere("abelha");
		arvoreEsquerda.insere("gaviao");
		arvoreEsquerda.insere("burro");
		ArvoreBinariaEncadeada<String> novaArvore = this.arvore.retornaArvoreEsquerda("jumento");
